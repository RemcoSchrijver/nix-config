...
vim.keymap.set("n", "<leader>tc", function() neotest.run.stop({ suite = true }) end, { desc = "Cancel all test" })
vim.keymap.set("n", "<leader>tn", function() neotest.run.attach() end, { desc = "Attach to nearest test" })
vim.keymap.set("n", "<leader>ts", function() neotest.output.open() end, { desc = "Show test output" })
vim.keymap.set("n", "<leader>tp", function() neotest.output_panel.toggle() end, { desc = "Toggle output panel" })
vim.keymap.set("n", "<leader>to", function() neotest.summary.toggle() end, { desc = "Toggle test summary panel" })
